...
class Character extends GameObject {
  ...
  draw() {
    if (this.spriteSheet) {
      ...
      const frameWidth =
        this.spriteData.pixels.width / this.spriteData.orientation.columns;
      const frameHeight =
        this.spriteData.pixels.height / this.spriteData.orientation.rows;
      ...
      // Store the spin angle as a property of the object (initialize it elsewhere)
